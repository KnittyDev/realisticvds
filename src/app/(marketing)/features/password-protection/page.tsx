            ...
            <MaxWidthWrapper>
                <AnimationContainer delay={0.1} className="w-full">
                    <div className="flex flex-col items-center justify-center py-10 max-w-lg mx-auto">
                        ...
                        With strong End-to-end encryption protection, your orders are sent in an encrypted language and we decrypt your order details with a special program, offering you a 100% anonymous experience without any records.                        </p>
                ...
                <AnimationContainer delay={0.4} className="w-full">
                    <LampContainer className="max-w-2xl mx-auto">
                        <div className="flex flex-col items-center justify-center relative w-full text-center">
                            ...
                            Take control of your future, try us once, I promise you will not lose anything, with 100% anonymous infrastructure, none of your information is kept by us, the entire system works autonomously!                            </p>
                            <div className="mt-6">
                                {/* <Button asChild>
